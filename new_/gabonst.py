...
def evolutionary_optimization(
    ...
    # Sort the costs and get the indices of the elite agents
    ...
    # Elite agents based on the lowest costs
    elite_agents = [population[i] for i in lowest_indices]

    # Apply mutations to low-cost agents
    ...
    # Apply crossover to high-cost agents
    ...
    # Filter out agents that improved after crossover
    inxs = []
    ...
    # Apply mutation to remaining high-cost agents
    ...
    # Filter out agents that improved after mutation
    inxs2 = []
    ...
    if pop_size > 0:
        initialized_agents = population_initialization(population_size=pop_size, agent_shape=population[0].shape,
                                                       ...
                                                       fixed_agent_shape=fixed_agent_shape, init_species=init_species,
