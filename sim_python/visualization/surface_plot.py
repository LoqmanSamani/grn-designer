...
def surface_animation(data_path, key, video_directory, video_name, frame_width=1500, frame_height=1500, c_map="RedBlack", title=None, x_label=None, y_label=None, z_label=None, title_fontsize=20, label_fontsize=16, tick_fontsize=12, colorbar=False):
    ...
    with h5py.File(data_path, 'r') as data:
        ...
        for i in range(z_data.shape[2]):
            ...
            surf = ax.plot_surface(X, Y, z_data[:, :, i], cmap=cmap_(c_map=c_map))
